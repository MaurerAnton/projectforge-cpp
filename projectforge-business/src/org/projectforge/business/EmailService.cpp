...
#include "org/projectforge/business/EmailService.hpp"
...
// Auto-generated implementation for EmailService.hpp
...
static bool _moduleInitialized = []() {
    spdlog::debug("Module business::EmailService initialized");
    return true;
}();
