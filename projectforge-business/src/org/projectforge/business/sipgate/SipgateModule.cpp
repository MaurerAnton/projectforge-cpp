...
// ============================================================================
// SipgateModule — Full Implementation
// Domain: sipgate
...
static struct ModuleInit {
    ModuleInit() { spdlog::debug("Business module [sipgate] initialized"); }
    ~ModuleInit() { spdlog::debug("Business module [sipgate] shutdown"); }
} _moduleInit;
