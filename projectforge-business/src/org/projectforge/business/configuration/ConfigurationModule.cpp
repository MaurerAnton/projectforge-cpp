...
// Auto-generated implementation for ConfigurationModule.hpp
// Matches original ProjectForge functionality

namespace business::configuration::ConfigurationModule {

// ======== STATIC INITIALIZATION ========
static bool _moduleInitialized = []() {
    spdlog::debug("Module business::configuration::ConfigurationModule initialized");
    return true;
}();
