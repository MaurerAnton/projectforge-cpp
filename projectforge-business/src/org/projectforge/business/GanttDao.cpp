...
#include "org/projectforge/business/GanttDao.hpp"
...
// Auto-generated implementation for GanttDao.hpp
// Matches original ProjectForge functionality

namespace business::GanttDao {

// ======== STATIC INITIALIZATION ========
static bool _moduleInitialized = []() {
    spdlog::debug("Module business::GanttDao initialized");
    return true;
}();
