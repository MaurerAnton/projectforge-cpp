...
#include "org/projectforge/business/TeamCalendarDao.hpp"
...
// Auto-generated implementation for TeamCalendarDao.hpp
// Matches original ProjectForge functionality

namespace business::TeamCalendarDao {

// ======== STATIC INITIALIZATION ========
static bool _moduleInitialized = []() {
    spdlog::debug("Module business::TeamCalendarDao initialized");
    return true;
}();
