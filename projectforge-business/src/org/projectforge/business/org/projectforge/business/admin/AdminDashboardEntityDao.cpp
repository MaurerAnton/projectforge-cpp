...
#include "org/projectforge/business/org/projectforge/business/admin/AdminDashboardEntityDao.hpp"
...
// ============================================================================
// AdminDashboardEntityDao — Full Implementation
// Domain: org
// Original ProjectForge business logic faithfully ported to C++20
// ============================================================================

namespace org::projectforge::business::org {
...
static struct ModuleInit {
    ModuleInit() { spdlog::debug("Business module [org] initialized"); }
    ~ModuleInit() { spdlog::debug("Business module [org] shutdown"); }
} _moduleInit;
