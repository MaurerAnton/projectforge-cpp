...
// ============================================================================
// ScriptingModule — Full Implementation
// Domain: scripting
...
static struct ModuleInit {
    ModuleInit() { spdlog::debug("Business module [scripting] initialized"); }
    ~ModuleInit() { spdlog::debug("Business module [scripting] shutdown"); }
} _moduleInit;
