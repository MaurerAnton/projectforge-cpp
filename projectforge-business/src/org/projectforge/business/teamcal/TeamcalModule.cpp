...
// ============================================================================
// TeamcalModule — Full Implementation
// Domain: teamcal
...
static struct ModuleInit {
    ModuleInit() { spdlog::debug("Business module [teamcal] initialized"); }
    ~ModuleInit() { spdlog::debug("Business module [teamcal] shutdown"); }
} _moduleInit;
