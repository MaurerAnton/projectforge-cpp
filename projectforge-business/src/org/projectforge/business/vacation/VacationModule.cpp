...
// ============================================================================
// VacationModule — Full Implementation
// Domain: vacation
...
static struct ModuleInit {
    ModuleInit() { spdlog::debug("Business module [vacation] initialized"); }
    ~ModuleInit() { spdlog::debug("Business module [vacation] shutdown"); }
} _moduleInit;
