...
#include "org/projectforge/business/user/GroupDao.hpp"
...
static struct ModuleInit {
    ModuleInit() { spdlog::debug("Business module [user] initialized"); }
    ~ModuleInit() { spdlog::debug("Business module [user] shutdown"); }
} _moduleInit;
