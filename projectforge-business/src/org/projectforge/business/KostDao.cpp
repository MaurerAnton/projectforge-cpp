...
#include "org/projectforge/business/KostDao.hpp"
...
// Auto-generated implementation for KostDao.hpp
// Matches original ProjectForge functionality

namespace business::KostDao {

// ======== STATIC INITIALIZATION ========
static bool _moduleInitialized = []() {
    spdlog::debug("Module business::KostDao initialized");
    return true;
}();
