...
#include "org/projectforge/business/timesheet/TimesheetDao.hpp"
...
// ============================================================================
// TimesheetDao — Full Implementation
// Domain: timesheet
...
static struct ModuleInit {
    ModuleInit() { spdlog::debug("Business module [timesheet] initialized"); }
    ~ModuleInit() { spdlog::debug("Business module [timesheet] shutdown"); }
} _moduleInit;
