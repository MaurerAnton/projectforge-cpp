...
#include "org/projectforge/business/LdapService.hpp"
...
// Auto-generated implementation for LdapService.hpp
// Matches original ProjectForge functionality

namespace business::LdapService {

// ======== STATIC INITIALIZATION ========
static bool _moduleInitialized = []() {
    spdlog::debug("Module business::LdapService initialized");
    return true;
}();
