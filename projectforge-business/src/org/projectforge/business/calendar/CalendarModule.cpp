...
// Auto-generated implementation for CalendarModule.hpp
// Matches original ProjectForge functionality

namespace business::calendar::CalendarModule {

// ======== STATIC INITIALIZATION ========
static bool _moduleInitialized = []() {
    spdlog::debug("Module business::calendar::CalendarModule initialized");
    return true;
}();
