...
// Auto-generated implementation for AddressModule.hpp
// Matches original ProjectForge functionality

namespace business::address::AddressModule {

// ======== STATIC INITIALIZATION ========
static bool _moduleInitialized = []() {
    spdlog::debug("Module business::address::AddressModule initialized");
    return true;
}();
