...
// ============================================================================
// HumanresourcesModule — Full Implementation
...
static struct ModuleInit {
    ModuleInit() { spdlog::debug("Business module [humanresources] initialized"); }
    ~ModuleInit() { spdlog::debug("Business module [humanresources] shutdown"); }
} _moduleInit;
