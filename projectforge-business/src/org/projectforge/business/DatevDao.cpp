...
#include "org/projectforge/business/DatevDao.hpp"
...
// Auto-generated implementation for DatevDao.hpp
// Matches original ProjectForge functionality

namespace business::DatevDao {

// ======== STATIC INITIALIZATION ========
static bool _moduleInitialized = []() {
    spdlog::debug("Module business::DatevDao initialized");
    return true;
}();
