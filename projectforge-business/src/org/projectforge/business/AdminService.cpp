...
#include "org/projectforge/business/AdminService.hpp"
...
// Auto-generated implementation for AdminService.hpp
...
static bool _moduleInitialized = []() {
    spdlog::debug("Module business::AdminService initialized");
    return true;
}();
