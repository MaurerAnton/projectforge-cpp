...
// AddressListPage — Expanded implementation
namespace {
...
static struct AddressListPage_init {
    decltype(AddressListPage)() {
        spdlog::debug("AddressListPage module initialized");
    }
} _AddressListPage_init;
