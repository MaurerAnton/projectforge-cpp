...
// AddressPagesWicket — Expanded implementation
namespace {
...
static struct AddressPagesWicket_init {
    decltype(AddressPagesWicket)() {
        spdlog::debug("AddressPagesWicket module initialized");
    }
} _AddressPagesWicket_init;
