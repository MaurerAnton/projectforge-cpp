...
// AddressEditPage — Expanded implementation
namespace {
...
static struct AddressEditPage_init {
    decltype(AddressEditPage)() {
        spdlog::debug("AddressEditPage module initialized");
    }
} _AddressEditPage_init;
