...
class HrPlanningListPage : public BaseListPage {
public:
    HrPlanningListPage() : BaseListPage("ProjectForge - HR Planning", "HR Planning") {
    ...
    static std::vector<std::string> getColumns() {
        return { "User", "Project", "Hours", "Start", "End", "Status", "Actions" };
    }
