...
class CalendarEventEditPage : public BaseEditPage {
public:
    CalendarEventEditPage(int64_t id = -1) : BaseEditPage("ProjectForge - Edit Event", "Edit Event"), entityId_(id) {
        buildForm();
    }
    ...
    static std::vector<std::string> getFieldNames() {
        return { "subject", "location", "startDate", "endDate", "allDay", "note" };
    }
