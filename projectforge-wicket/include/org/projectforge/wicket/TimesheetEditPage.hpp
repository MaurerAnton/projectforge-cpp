...
class TimesheetEditPage : public BaseEditPage {
public:
    TimesheetEditPage(int64_t id = -1) : BaseEditPage("ProjectForge - Edit Timesheet", "Edit Timesheet"), entityId_(id) {
        buildForm();
    }
    ...
    static std::vector<std::string> getFieldNames() {
        return { "description", "task", "location", "kost2", "tags" };
    }
