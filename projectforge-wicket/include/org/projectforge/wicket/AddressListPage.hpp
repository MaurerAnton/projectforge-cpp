...
class AddressListPage : public BaseListPage {
public:
    AddressListPage() : BaseListPage("ProjectForge - Addresses", "Addresses") {
    ...
    static std::vector<std::string> getColumns() {
        return { "Name", "Organization", "Email", "Phone", "City", "Actions" };
    }
