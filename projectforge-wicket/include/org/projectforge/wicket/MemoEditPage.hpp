...
class MemoEditPage : public BaseEditPage {
public:
    MemoEditPage(int64_t id = -1) : BaseEditPage("ProjectForge - Edit Memo", "Edit Memo"), entityId_(id) {
        buildForm();
    }
    ...
    static std::vector<std::string> getFieldNames() {
        return { "title", "content", "sharedWith" };
    }
