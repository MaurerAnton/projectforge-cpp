...
class FibuAuftragListPage : public BaseListPage {
public:
    FibuAuftragListPage() : BaseListPage("ProjectForge - Orders", "Orders") {
    ...
    static std::vector<std::string> getColumns() {
        return { "Number", "Subject", "Customer", "Date", "Status", "Actions" };
    }
