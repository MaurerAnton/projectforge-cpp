...
class FibuRechnungListPage : public BaseListPage {
public:
    FibuRechnungListPage() : BaseListPage("ProjectForge - Invoices", "Invoices") {
    ...
    static std::vector<std::string> getColumns() {
        return { "Number", "Subject", "Customer", "Date", "Net", "Gross", "Status", "Actions" };
    }
