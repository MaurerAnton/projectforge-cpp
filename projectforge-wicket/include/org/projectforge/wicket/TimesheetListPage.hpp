...
class TimesheetListPage : public BaseListPage {
public:
    TimesheetListPage() : BaseListPage("ProjectForge - Timesheets", "Timesheets") {
    ...
    static std::vector<std::string> getColumns() {
        return { "Start Time", "Stop Time", "Duration", "Task", "Description", "Actions" };
    }
