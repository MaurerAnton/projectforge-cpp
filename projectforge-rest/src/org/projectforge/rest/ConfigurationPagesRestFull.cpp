...
// ============================================================================
// ConfigurationPagesRest — Complete REST API Implementation
...
static bool validateRequest(const drogon::HttpRequestPtr& req, nlohmann::json& outBody) {
    ...
    try {
        ...
        spdlog::error("[ConfigurationPagesRest] Invalid JSON: {}", e.what());
        return false;
    }
}
...
static nlohmann::json handleGetList(const drogon::HttpRequestPtr& req) {
    ...
    spdlog::info("[ConfigurationPagesRest] GET list: page={}, pageSize={}", filter["page"], filter["pageSize"]);
    return result;
}
...
static nlohmann::json handleGetById(int64_t id) {
    ...
    spdlog::info("[ConfigurationPagesRest] GET by id: {}", id);
    return result;
}
...
static nlohmann::json handleCreate(const nlohmann::json& body) {
    ...
    spdlog::info("[ConfigurationPagesRest] Created new entity");
    return result;
}
...
static nlohmann::json handleUpdate(int64_t id, const nlohmann::json& body) {
    ...
    spdlog::info("[ConfigurationPagesRest] Updated entity id={}", id);
    return result;
}
...
static nlohmann::json handleDelete(int64_t id) {
    ...
    spdlog::info("[ConfigurationPagesRest] Deleted entity id={}", id);
    return result;
}
...
static struct ConfigurationPagesRestAutoReg {
    ConfigurationPagesRestAutoReg() {
        spdlog::info("[ConfigurationPagesRest] Registering routes at /api/v1//config");
        ConfigurationPagesRest::registerRoutes();
    }
} _ConfigurationPagesRestAutoReg;
