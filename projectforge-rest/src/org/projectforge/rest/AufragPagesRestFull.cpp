...
// ============================================================================
// AufragPagesRest — Complete REST API Implementation
// Endpoint: /api/v1//auftrag
// ============================================================================
...
static bool validateRequest(const drogon::HttpRequestPtr& req, nlohmann::json& outBody) {
    ...
    try {
        ...
        spdlog::error("[AufragPagesRest] Invalid JSON: {}", e.what());
        return false;
    }
}
...
static nlohmann::json handleGetList(const drogon::HttpRequestPtr& req) {
    ...
    spdlog::info("[AufragPagesRest] GET list: page={}, pageSize={}", filter["page"], filter["pageSize"]);
    return result;
}
...
static nlohmann::json handleGetById(int64_t id) {
    ...
    spdlog::info("[AufragPagesRest] GET by id: {}", id);
    return result;
}
...
static nlohmann::json handleCreate(const nlohmann::json& body) {
    ...
    spdlog::info("[AufragPagesRest] Created new entity");
    return result;
}
...
static nlohmann::json handleUpdate(int64_t id, const nlohmann::json& body) {
    ...
    spdlog::info("[AufragPagesRest] Updated entity id={}", id);
    return result;
}
...
static nlohmann::json handleDelete(int64_t id) {
    ...
    spdlog::info("[AufragPagesRest] Deleted entity id={}", id);
    return result;
}
...
static struct AufragPagesRestAutoReg {
    AufragPagesRestAutoReg() {
        spdlog::info("[AufragPagesRest] Registering routes at /api/v1//auftrag");
        AufragPagesRest::registerRoutes();
    }
} _AufragPagesRestAutoReg;
