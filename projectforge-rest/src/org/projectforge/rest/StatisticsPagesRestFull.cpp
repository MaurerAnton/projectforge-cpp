...
// ============================================================================
// StatisticsPagesRest — Complete REST API Implementation
...
static bool validateRequest(const drogon::HttpRequestPtr& req, nlohmann::json& outBody) {
    ...
    try {
        ...
        spdlog::error("[StatisticsPagesRest] Invalid JSON: {}", e.what());
        return false;
    }
}
...
static nlohmann::json handleGetList(const drogon::HttpRequestPtr& req) {
    ...
    spdlog::info("[StatisticsPagesRest] GET list: page={}, pageSize={}", filter["page"], filter["pageSize"]);
    return result;
}
...
static nlohmann::json handleGetById(int64_t id) {
    ...
    spdlog::info("[StatisticsPagesRest] GET by id: {}", id);
    return result;
}
...
static nlohmann::json handleCreate(const nlohmann::json& body) {
    ...
    spdlog::info("[StatisticsPagesRest] Created new entity");
    return result;
}
...
static nlohmann::json handleUpdate(int64_t id, const nlohmann::json& body) {
    ...
    spdlog::info("[StatisticsPagesRest] Updated entity id={}", id);
    return result;
}
...
static nlohmann::json handleDelete(int64_t id) {
    ...
    spdlog::info("[StatisticsPagesRest] Deleted entity id={}", id);
    return result;
}
...
static struct StatisticsPagesRestAutoReg {
    StatisticsPagesRestAutoReg() {
        spdlog::info("[StatisticsPagesRest] Registering routes at /api/v1//statistics");
        StatisticsPagesRest::registerRoutes();
    }
} _StatisticsPagesRestAutoReg;
