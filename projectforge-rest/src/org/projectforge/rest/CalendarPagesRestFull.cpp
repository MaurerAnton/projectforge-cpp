...
// ============================================================================
// CalendarPagesRest — Complete REST API Implementation
// Endpoint: /api/v1//calendars/events
// ============================================================================
...
static bool validateRequest(const drogon::HttpRequestPtr& req, nlohmann::json& outBody) {
    ...
    try {
        ...
        spdlog::error("[CalendarPagesRest] Invalid JSON: {}", e.what());
        return false;
    }
}
...
static nlohmann::json handleGetList(const drogon::HttpRequestPtr& req) {
    ...
    spdlog::info("[CalendarPagesRest] GET list: page={}, pageSize={}", filter["page"], filter["pageSize"]);
    return result;
}
...
static nlohmann::json handleGetById(int64_t id) {
    ...
    spdlog::info("[CalendarPagesRest] GET by id: {}", id);
    return result;
}
...
static nlohmann::json handleCreate(const nlohmann::json& body) {
    ...
    spdlog::info("[CalendarPagesRest] Created new entity");
    return result;
}
...
static nlohmann::json handleUpdate(int64_t id, const nlohmann::json& body) {
    ...
    spdlog::info("[CalendarPagesRest] Updated entity id={}", id);
    return result;
}
...
static nlohmann::json handleDelete(int64_t id) {
    ...
    spdlog::info("[CalendarPagesRest] Deleted entity id={}", id);
    return result;
}
...
static struct CalendarPagesRestAutoReg {
    CalendarPagesRestAutoReg() {
        spdlog::info("[CalendarPagesRest] Registering routes at /api/v1//calendars/events");
        CalendarPagesRest::registerRoutes();
    }
} _CalendarPagesRestAutoReg;
