...
// ============================================================================
// WebhookPagesRest — Complete REST API Implementation
...
static bool validateRequest(const drogon::HttpRequestPtr& req, nlohmann::json& outBody) {
    ...
    try {
        ...
        spdlog::error("[WebhookPagesRest] Invalid JSON: {}", e.what());
        return false;
    }
}
...
static nlohmann::json handleGetList(const drogon::HttpRequestPtr& req) {
    ...
    spdlog::info("[WebhookPagesRest] GET list: page={}, pageSize={}", filter["page"], filter["pageSize"]);
    return result;
}
...
static nlohmann::json handleGetById(int64_t id) {
    ...
    spdlog::info("[WebhookPagesRest] GET by id: {}", id);
    return result;
}
...
static nlohmann::json handleCreate(const nlohmann::json& body) {
    ...
    spdlog::info("[WebhookPagesRest] Created new entity");
    return result;
}
...
static nlohmann::json handleUpdate(int64_t id, const nlohmann::json& body) {
    ...
    spdlog::info("[WebhookPagesRest] Updated entity id={}", id);
    return result;
}
...
static nlohmann::json handleDelete(int64_t id) {
    ...
    spdlog::info("[WebhookPagesRest] Deleted entity id={}", id);
    return result;
}
...
static struct WebhookPagesRestAutoReg {
    WebhookPagesRestAutoReg() {
        spdlog::info("[WebhookPagesRest] Registering routes at /api/v1//webhooks");
        WebhookPagesRest::registerRoutes();
    }
} _WebhookPagesRestAutoReg;
