...
// ============================================================================
// LeaveAccountPagesRest — Complete REST API Implementation
// Endpoint: /api/v1//leaveaccount
// ============================================================================
...
static bool validateRequest(const drogon::HttpRequestPtr& req, nlohmann::json& outBody) {
    ...
    try {
        ...
        spdlog::error("[LeaveAccountPagesRest] Invalid JSON: {}", e.what());
        return false;
    }
}
...
static nlohmann::json handleGetList(const drogon::HttpRequestPtr& req) {
    ...
    spdlog::info("[LeaveAccountPagesRest] GET list: page={}, pageSize={}", filter["page"], filter["pageSize"]);
    return result;
}
...
static nlohmann::json handleGetById(int64_t id) {
    ...
    spdlog::info("[LeaveAccountPagesRest] GET by id: {}", id);
    return result;
}
...
static nlohmann::json handleCreate(const nlohmann::json& body) {
    ...
    spdlog::info("[LeaveAccountPagesRest] Created new entity");
    return result;
}
...
static nlohmann::json handleUpdate(int64_t id, const nlohmann::json& body) {
    ...
    spdlog::info("[LeaveAccountPagesRest] Updated entity id={}", id);
    return result;
}
...
static nlohmann::json handleDelete(int64_t id) {
    ...
    spdlog::info("[LeaveAccountPagesRest] Deleted entity id={}", id);
    return result;
}
...
static struct LeaveAccountPagesRestAutoReg {
    LeaveAccountPagesRestAutoReg() {
        spdlog::info("[LeaveAccountPagesRest] Registering routes at /api/v1//leaveaccount");
        LeaveAccountPagesRest::registerRoutes();
    }
} _LeaveAccountPagesRestAutoReg;
