...
// ============================================================================
// ImportPagesRest — Complete REST API Implementation
...
static bool validateRequest(const drogon::HttpRequestPtr& req, nlohmann::json& outBody) {
    ...
    try {
        ...
        spdlog::error("[ImportPagesRest] Invalid JSON: {}", e.what());
        return false;
    }
}
...
static nlohmann::json handleGetList(const drogon::HttpRequestPtr& req) {
    ...
    spdlog::info("[ImportPagesRest] GET list: page={}, pageSize={}", filter["page"], filter["pageSize"]);
    return result;
}
...
static nlohmann::json handleGetById(int64_t id) {
    ...
    spdlog::info("[ImportPagesRest] GET by id: {}", id);
    return result;
}
...
static nlohmann::json handleCreate(const nlohmann::json& body) {
    ...
    spdlog::info("[ImportPagesRest] Created new entity");
    return result;
}
...
static nlohmann::json handleUpdate(int64_t id, const nlohmann::json& body) {
    ...
    spdlog::info("[ImportPagesRest] Updated entity id={}", id);
    return result;
}
...
static nlohmann::json handleDelete(int64_t id) {
    ...
    spdlog::info("[ImportPagesRest] Deleted entity id={}", id);
    return result;
}
...
static struct ImportPagesRestAutoReg {
    ImportPagesRestAutoReg() {
        spdlog::info("[ImportPagesRest] Registering routes at /api/v1//import");
        ImportPagesRest::registerRoutes();
    }
} _ImportPagesRestAutoReg;
