...
// ============================================================================
// HrPlanningPagesRest — Complete REST API Implementation
// Endpoint: /api/v1/HrPlanning
// ============================================================================
...
static bool validateRequest(const drogon::HttpRequestPtr& req, nlohmann::json& outBody) {
    ...
    try {
        ...
        spdlog::error("[HrPlanningPagesRest] Invalid JSON: {}", e.what());
        return false;
    }
}
...
static nlohmann::json handleGetList(const drogon::HttpRequestPtr& req) {
    ...
    spdlog::info("[HrPlanningPagesRest] GET list: page={}, pageSize={}", filter["page"], filter["pageSize"]);
    return result;
}
...
static nlohmann::json handleGetById(int64_t id) {
    ...
    spdlog::info("[HrPlanningPagesRest] GET by id: {}", id);
    return result;
}
...
static nlohmann::json handleCreate(const nlohmann::json& body) {
    ...
    spdlog::info("[HrPlanningPagesRest] Created new entity");
    return result;
}
...
static nlohmann::json handleUpdate(int64_t id, const nlohmann::json& body) {
    ...
    spdlog::info("[HrPlanningPagesRest] Updated entity id={}", id);
    return result;
}
...
static nlohmann::json handleDelete(int64_t id) {
    ...
    spdlog::info("[HrPlanningPagesRest] Deleted entity id={}", id);
    return result;
}
...
static struct HrPlanningPagesRestAutoReg {
    HrPlanningPagesRestAutoReg() {
        spdlog::info("[HrPlanningPagesRest] Registering routes at /api/v1/HrPlanning");
        HrPlanningPagesRest::registerRoutes();
    }
} _HrPlanningPagesRestAutoReg;
