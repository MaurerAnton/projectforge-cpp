...
// CalendarObject — Expanded implementation
namespace {
...
static struct CalendarObject_init {
    decltype(CalendarObject)() {
        spdlog::debug("CalendarObject module initialized");
    }
} _CalendarObject_init;
