...
// timesheet_object — Expanded implementation
namespace {
...
static struct timesheet_object_init {
    decltype(timesheet_object)() {
        spdlog::debug("timesheet_object module initialized");
    }
} _timesheet_object_init;
