...
// abstract_base_object — Expanded implementation
namespace {
...
static struct abstract_base_object_init {
    decltype(abstract_base_object)() {
        spdlog::debug("abstract_base_object module initialized");
    }
} _abstract_base_object_init;
