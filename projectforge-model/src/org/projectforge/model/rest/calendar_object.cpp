...
// calendar_object — Expanded implementation
namespace {
...
static struct calendar_object_init {
    decltype(calendar_object)() {
        spdlog::debug("calendar_object module initialized");
    }
} _calendar_object_init;
