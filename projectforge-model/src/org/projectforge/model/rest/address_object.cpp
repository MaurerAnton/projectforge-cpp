...
// address_object — Expanded implementation
namespace {
...
static struct address_object_init {
    decltype(address_object)() {
        spdlog::debug("address_object module initialized");
    }
} _address_object_init;
