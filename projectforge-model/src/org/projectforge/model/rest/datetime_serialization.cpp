...
// datetime_serialization — Expanded implementation
namespace {
...
static struct datetime_serialization_init {
    decltype(datetime_serialization)() {
        spdlog::debug("datetime_serialization module initialized");
    }
} _datetime_serialization_init;
