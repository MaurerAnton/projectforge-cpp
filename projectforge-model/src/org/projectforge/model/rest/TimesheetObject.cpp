...
// TimesheetObject — Expanded implementation
namespace {
...
static struct TimesheetObject_init {
    decltype(TimesheetObject)() {
        spdlog::debug("TimesheetObject module initialized");
    }
} _TimesheetObject_init;
