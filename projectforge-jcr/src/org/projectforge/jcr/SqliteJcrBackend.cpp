...
// SqliteJcrBackend — Expanded implementation
namespace {
...
static struct SqliteJcrBackend_init {
    decltype(SqliteJcrBackend)() {
        spdlog::debug("SqliteJcrBackend module initialized");
    }
} _SqliteJcrBackend_init;
