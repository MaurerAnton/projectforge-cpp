...
// FileSystemJcrBackend — Expanded implementation
namespace {
...
static struct FileSystemJcrBackend_init {
    decltype(FileSystemJcrBackend)() {
        spdlog::debug("FileSystemJcrBackend module initialized");
    }
} _FileSystemJcrBackend_init;
