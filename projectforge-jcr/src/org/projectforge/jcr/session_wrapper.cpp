...
// session_wrapper — Expanded implementation
namespace {
...
static struct session_wrapper_init {
    decltype(session_wrapper)() {
        spdlog::debug("session_wrapper module initialized");
    }
} _session_wrapper_init;
