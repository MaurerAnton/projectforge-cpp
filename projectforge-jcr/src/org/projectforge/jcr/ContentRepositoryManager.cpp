...
// ContentRepositoryManager — Expanded implementation
namespace {
...
static struct ContentRepositoryManager_init {
    decltype(ContentRepositoryManager)() {
        spdlog::debug("ContentRepositoryManager module initialized");
    }
} _ContentRepositoryManager_init;
